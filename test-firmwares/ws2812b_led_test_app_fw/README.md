...
**Output files:**
- `build/ws2812b-led-test-app-fw.bin` - Unsigned binary (if you do NOT use bootloader)
- `build/ws2812b-led-test-app-fw_signed.bin` - **If you do use bootloader** (includes CRC32)
